<html>
<head>
<title>Sleek Entertainment</title>
...
<div class="col-md-6 left-box">
	...
	<p>Subscribe to this website to book and pay for movies and series online.<br>Only a CLICK away!!</p>
	<a href="register.php" class="signup-btn"><i class="fa fa-user"></i>Sign up</a>
	<h5>Storyline: </h5>
	<p>Our friendly neighborhood Super Hero decides to join his best friends Ned, MJ, and the rest of the gang on a European vacation. However, Peter's plan to leave super heroics behind for a few weeks are quickly scrapped when he begrudgingly agrees to help Nick Fury uncover the mystery of several elemental creature attacks, creating havoc across the continent. Written by Sony Pictures Entertainment</p>
	<h5>Genres:</h5>
	<p>Action |  Adventure | Sci-Fiction</p>
	<h5>Release Date:</h5>
	<p>2 July 2019 (USA)</p>
	...
	<h5>Directed by: </h5> 
<p>Jon Watts</p>	
<h5>Writing Credits: </h5>  
<p>Chris McKenna	...	(written by) &</p>
<p>Erik Sommers	...	(written by)</p>
 
<p>Stan Lee	...	(based on the Marvel comic book by) and</p>
...
<div class="container series">
	<h3>Latest HD Movie Releases</h3>	
<div class="row">
<div class="col-md-4">
	<div class="row">
